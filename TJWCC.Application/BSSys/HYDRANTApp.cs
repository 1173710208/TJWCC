...
namespace TJWCC.Application.BSSys
{
    ...
    public class HYDRANTApp
    {
        private IHYDRANTRepository service = new HYDRANTRepository();

        /// <summary>
        /// 获取SCADA
        /// </summary>
        /// <returns></returns>
        public List<HYDRANTEntity> GetList()
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public List<HYDRANTEntity> GetList(Pagination pagination, int id)
        {
            var expression = ExtLinq.True<HYDRANTEntity>();
        ...
        public void SubmitForm(HYDRANTEntity moduleEntity, string id)
        {
