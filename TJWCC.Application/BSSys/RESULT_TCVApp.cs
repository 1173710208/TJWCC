...
namespace TJWCC.Application.BSSys
{
    ...
    public class RESULT_TCVApp
    {
        private IRESULT_TCVRepository service = new RESULT_TCVRepository();

        /// <summary>
        /// 获取SCADA
        /// </summary>
        /// <returns></returns>
        public List<RESULT_TCVEntity> GetList()
        {
            return service.IQueryable().ToList();
        }
        public List<RESULT_TCVEntity> GetList(int id)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public List<RESULT_TCVEntity> GetList(Pagination pagination, int id)
        {
            var expression = ExtLinq.True<RESULT_TCVEntity>();
        ...
        public void SubmitForm(RESULT_TCVEntity moduleEntity, string id)
        {
