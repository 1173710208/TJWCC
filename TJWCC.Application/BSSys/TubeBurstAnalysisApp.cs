...
namespace TJWCC.Application.BSSys
{
    ...
    public class TubeBurstAnalysisApp
    {
        ...
        private ArrayList _foundMeter = new ArrayList();
        ...
        public ArrayList IsolateNode(int elementID, int elementType, ArrayList _canNotBeclosedValves = null)
        {
            ...
            if (_canNotBeclosedValves != null)
            {
                for (int i = 0; i < _canNotBeclosedValves.Count; i++)
                {
                    ...
                    long tmpeId =Convert.ToInt64(_canNotBeclosedValves[i]);
                    ...
                    case "影响的用户":
                        {
                            ...
                            var bsblts = BSB_LinkedTable.GetList(foundJunctions);
                            var bsBusinessToPipe = (from bsblt in bsblts
                                                    select new
                                                    {
                                                        bsblt.ElementId,
                                                        bsblt.WaterMeter_ID,
                            ...
                            if (jv != null)
                                ...
                                {
                                    _foundMeter.Add(jv[i].ELEMENTID.ToInt());
        ...
        public void title()
        {
            ...
            titleArr.Add(Math.Round(volume/31.0, 2));
