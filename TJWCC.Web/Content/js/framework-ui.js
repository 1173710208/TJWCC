...
$.currentWindow = function () {
    var iframeId = top.$(".TJWCC_iframe:visible").attr("id");
...
$.modalAlert = function (title, content, type) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.state == "success") {
                            ...
                            $.modalAlert("系统提示", data.message, data.state);
                        }
                    },
                    error: function (XMLHttpRequest, textStatus, errorThrown) {
                        $.loading(false);
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $element.select2({
                    ...
                    multiple: options.multiple == true ? "multiple" : ""
                });
...
$.fn.authorizeButton = function () {
    var moduleId = top.$(".TJWCC_iframe:visible").attr("id").substr(6);
