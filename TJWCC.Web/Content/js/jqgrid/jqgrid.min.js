...
(function (factory) {
    ...
    $.extend($.jgrid, {
        ...
        getRegional: function (inst, param, deval) {
            var ret;
            if (deval !== undefined) {
                return deval;
            }
            ...
            if (ret && $.type(ret) === 'object') {
                ...
                if (ret.treeGrid) {
                    var i = 1, len = grid[0].rows.length,
                        ...
                        isLeaf = ret.treeReader.leafield,
    ...
    $.jgrid.extend({
        setTreeNode: function (i, len) {
            return this.each(function () {
                ...
                var expCol = $t.p.expColInd,
                    expanded = $t.p.treeReader.expanded_field,
                    isLeaf = $t.p.treeReader.leafield,
            ...
            return this.each(function () {
                ...
                $.each($t.p.treeReader, function (j, n) {
                    if (n && $.inArray(n, dupcols) === -1) {
                        if (j === 'leafield') { $t.p._treeleafpos = i; }
                        i++;
                        $t.p.colNames.push(n);
        ...
        isNodeLoaded: function (rc) {
            ...
            this.each(function () {
                var $t = this;
                if (!$t.grid || !$t.p.treeGrid) { return; }
                var isLeaf = $t.p.treeReader.leafield,
        ...
        setLeaf: function (rc, state, collapsed) {
            return this.each(function () {
                var id = $.jgrid.getAccessor(rc, this.p.localReader.id),
                    ...
                    isLeaf = this.p.treeReader.leafield;
                try {
                ...
                if (!reloadcurrent) {
                    if (!jQuery._data(this, "events").jqGridAfterSetTreeNode) {
                        $(this).bind("jqGridAfterSetTreeNode.reloadNode", function () {
                            var isLeaf = this.p.treeReader.leafield;
